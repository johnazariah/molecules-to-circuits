...
**Local proof, 19 September 2026:** The corrected and expanded manuscript
produces a 291-page PDF and a 61-page sample in the repository's current
layout. Its 83,235-word source inventory includes code, tables and markup.
These are proofing artifacts, not Apress's final pagination or a new public
edition. The implementation and evidence record is in
[the authoritative audit](.review/CORRECTNESS-AUDIT.md#final-implementation-acceptance--2026-09-19).
